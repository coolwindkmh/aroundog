               ...
               <div class="row justify-content-center">
                    ...
                    <div class="form-row" style="display:block">
                       ...
                       <div class="col-6 mb-30">
                          <label for="state">지도선택</label>
                           <div class="select-option" id="service-select">
                        <textarea class="form-control" id="exampleTextarea" rows="5" placeholder="지도적용"></textarea>
                        </div>                          
                       </div>                       
                       <!-- <div class="col-6 mb-30">
                  ...
                  <!--   <fieldset class="form-group">
                    ...
                    <div class="form-group" style="width:100%" >
                      ...
                      <textarea class="form-control" id="exampleTextarea" rows="5" placeholder="제보하려는 동물에 대해서 상세한 내용을 적어주세요"></textarea>
                    </div>                    
                    <button type="submit" class="primary-btn float-right">제보하기</button>
                  </form>
               </div>
            </div>   
         </section>
