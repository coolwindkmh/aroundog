...
public class ReportController {
   ...
   /*
    * @RequestMapping(value="/report",method=RequestMethod.GET) public ModelAndView
    * selectAll() { ModelAndView mav = new ModelAndView("report/list");
    * List<Report> reportList = reportService.selectAll();
    * mav.addObject("reportList",reportList);
    * System.out.println("reportList 사이즈는 "+reportList.size()); return mav; }
    */
}